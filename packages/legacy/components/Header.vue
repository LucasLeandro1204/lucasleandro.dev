<template>
  <header id="home" class="pt-28 sm:pt-32">
    ...
    >
      <div class="max-w-xl mx-auto flex justify-between">
        ...
        <ul class="list-reset flex text-sm items-center">
          ...
          >
            <a class="text-white hover:text-primary transition" :href="anchor" v-text="label" />
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="max-w-xl text-white mx-auto">
      ...
      <p class="text-sm sm:text-base leading-loose sm:leading-normal">
        My name Is Lucas Leandro, I'm a Full Stack Developer from Florianópolis, Santa Catarina - Brazil.
      </p>
      <p class="text-sm sm:text-base leading-loose sm:leading-normal mb-4 text-primary">
        I solve problems.
      </p>
      <p class="text-sm sm:text-base leading-loose sm:leading-normal mb-4">
        At Front-end I work with <span class="text-primary">Vue</span> and <span class="text-primary">React</span>, I do make use of css preprocessors like <span class="text-primary">SCSS</span>. For static websites I use <span class="text-primary">Nuxt</span>.
      </p>
      <p class="text-sm sm:text-base leading-loose sm:leading-normal">
        My Back-end stack is primarily PHP (<span class="text-primary">Laravel</span>, Codeigniter perhaps), but I also work with <span class="text-primary">Node</span> (<span class="text-primary">Express</span>, Koa, Adonis). I do have experience with relational databases (<span class="text-primary">MySQL</span>) and NoSQL (<span class="text-primary">MongoDB</span>). I write <span class="text-primary">tests</span> for every project, they help me preventing bugs, and keeping the application stable as it grows.
      </p>
    </div>
  </header>
</template>
